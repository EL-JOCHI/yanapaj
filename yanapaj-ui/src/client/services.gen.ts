...
export class TaskControllerService {
  public static getTaskById<ThrowOnError extends boolean = false>(
  ...
  public static updateTask<ThrowOnError extends boolean = false>(
  ...
  public static deleteTask<ThrowOnError extends boolean = false>(
  ...
  public static createTask<ThrowOnError extends boolean = false>(
